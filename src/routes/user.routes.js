...
import { addToCart, clearCartProducts, deleteAccount, getCartProducts, getMyProfile, getWishlist, removeFromCart, toggleWishlistProducts, updateUserAccountDetails } from "../controllers/user/profile.controller.js";
...
router.route("/remove-from-cart/:productId").patch(verifyJWT,removeFromCart);
